...
import Lib.Discount.BOGOPricingStrategy;
import Lib.Discount.BulkPricingStrategy;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        pricingService.addStrategy("P001", new BOGOPricingStrategy());
        pricingService.addStrategy("P002", new BulkPricingStrategy(6, 0.10));
        ...
        pricingService.addStrategy("P001", new BulkPricingStrategy(3, 0.50)); // เปลี่ยนโปรโมชัน Apple เป็นซื้อ 3 ลด 50%
